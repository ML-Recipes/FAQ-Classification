...
class Dataset(object):
    ...
    :param sample: boolean flag to apply sampling
    ...
    """
    def __init__(self, tokenizer=None, sample=False, label_col="label", text_col="text", test_size=0.20, random_state=42, batch_size=32):
